...
public class GeneratorNode extends NodeShadow implements Comparable<GeneratorNode> {
    //added
    private  Location relevantDistance;

    public Location getRelevantDistance() {
        return relevantDistance;
    }

    public void setRelevantDistance(Location relevantDistance) {
        this.relevantDistance = relevantDistance;
    }
